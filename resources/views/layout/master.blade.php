...
<head>
    ...
    <link href="../../assets/img/laravel.svg" rel="icon">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #1a202c;">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('dashboard_') }}">
